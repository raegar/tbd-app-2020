...
const ClearingOfferMadePageThree = (props) => {
<Container>
...
• The applicant must then add UCP as their Clearing Choice via UCAS Track (ideally within 24 hours). If the applicant does not have a UCAS application and they are only wishing to apply to UCP, an RPA form can be completed in place of UCAS - speak to Zoe Rumball </p>
 </Container>

}
export default ClearingOfferMadePageThree;